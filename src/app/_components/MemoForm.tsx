...
export default function MemoForm(props: MemoFormProps) {
  ...
  return (
    <div className="space-y-4 bg-white text-black">
      ...
      <textarea id="caption" className={boxClass} value={caption}
        onChange={(e) => onCaptionChange(e.target.value)} disabled={isSubmitting}
      ...
      <div>
        ...
        <textarea id="why" className={boxClass} value={answerWhy}
          onChange={(e) => onWhyChange(e.target.value)} disabled={isSubmitting} placeholder="理由・背景"
        />
      </div>
      ...
      <div>
        ...
        <textarea id="what" className={boxClass} value={answerWhat}
          onChange={(e) => onWhatChange(e.target.value)} disabled={isSubmitting} placeholder="出来事・気づき"
        />
      </div>
      ...
      <div>
        ...
        <textarea id="next" className={boxClass} value={answerNext}
          onChange={(e) => onNextChange(e.target.value)} disabled={isSubmitting} placeholder="次の一手・教訓"
        />
      </div>
